...
/**
  ...
  @param {Object} [options]
    ...
    @param {Array[String]} [options.autoRefreshToken] list of origins that (besides the origin of the Ember.js application) send the authentication token to - defaults to `[]`
**/
