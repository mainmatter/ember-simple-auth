...
export default Ember.Service.extend(Ember.Evented, {
  ...
  */
  ...
  /**
    ...
    This function accepts any number of arguments but two at minimum. The first argument is
    always the name of the used authorizer and the last argument is always a function (`block`) to
    be called with the authorization data generated by the authorizer. Between those two arguments,
    zero or more additional arguments can be given and they will be bassed on as is to the authorizer
    when called.
