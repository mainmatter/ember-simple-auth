...
if(i+=e.parentNode?e.parentNode.className:"",r=/\blang(?:uage)?-([\w-]+)\b/i.exec(i))return p(r[1])?r[1]:"no-highlight"
for(n=0,t=(i=i.split(/\s+/)).length;t>n;n++)if(p(i[n])||a(i[n]))return i[n]}function o(e,n){var r,t={}
for(r in e)t[r]=e[r]
...
return a}(e,0),n}function s(e,t,a){function i(){return e.length&&t.length?e[0].offset!=t[0].offset?e[0].offset<t[0].offset?e:t:"start"==t[0].event?e:t:e.length?e:t}function o(e){l+="<"+r(e)+Array.prototype.map.call(e.attributes,function(e){return" "+e.nodeName+'="'+n(e.value)+'"'}).join("")+">"}function c(e){l+="</"+r(e)+">"}function s(e){("start"==e.event?o:c)(e.node)}for(var u=0,l="",f=[];e.length||t.length;){var b=i()
...
return e}return e.eW?c(e.parent,n):void 0}function s(e,n){return!a&&t(n.iR,e)}function b(e,n){var r=R.cI?n[0].toLowerCase():n[0]
return e.k.hasOwnProperty(r)&&e.k[r]}function g(e,n,r,t){var a='<span class="'+(t?"":v.classPrefix)
return(a+=e+'">')+n+(r?"":"</span>")}function d(){if(!x.k)return n(k)
var e="",r=0
x.lR.lastIndex=0
...
if(e&&!m[x.sL])return n(k)
var r=e?l(x.sL,k,!0,M[x.sL]):f(k,x.sL.length?x.sL:void 0)
return x.r>0&&(L+=r.r),e&&(M[x.sL]=r.top),g(r.language,r.value,!1,!0)}function N(){return void 0!==x.sL?h():d()}function E(e,r){var t=e.cN?g(e.cN,"",!0):""
e.rB?(C+=t,k=""):e.eB?(C+=n(r)+t,k=""):(C+=t,k=r),x=Object.create(e,{parent:{value:x}})}function w(e,r){if(k+=e,void 0===r)return C+=N(),0
var t=o(r,x)
if(t)return C+=N(),E(t,r),t.rB?0:r.length
var a=c(x,r)
if(a){var i=x
i.rE||i.eE||(k+=r),C+=N()
do{x.cN&&(C+="</span>"),L+=x.r,x=x.parent}while(x!=a.parent)
return i.eE&&(C+=n(r)),k="",a.starts&&E(a.starts,""),i.rE?0:r.length}if(s(r,x))throw new Error('Illegal lexeme "'+r+'" for mode "'+(x.cN||"<unnamed>")+'"')
return k+=r,r.length||1}var R=p(e)
if(!R)throw new Error('Unknown language: "'+e+'"')
u(R)
var y,x=i||R,M={},C=""
for(y=x;y!=R;y=y.parent)y.cN&&(C=g(y.cN,"",!0)+C)
var k="",L=0
try{for(var B,I,A=0;x.t.lastIndex=A,B=x.t.exec(r);)I=w(r.substr(A,B.index-A),B[0]),A=B.index+I
for(w(r.substr(A)),y=x;y.parent;y=y.parent)y.cN&&(C+="</span>")
return{r:L,value:C,language:e,top:x}}catch(e){if(-1!=e.message.indexOf("Illegal"))return{r:0,value:n(r)}
throw e}}function f(e,r){r=r||v.languages||Object.keys(m)
var t={r:0,value:n(e)},a=t
return r.forEach(function(n){if(p(n)){var r=l(n,e,!1)
r.language=n,r.r>a.r&&(a=r),r.r>t.r&&(a=t,t=r)}}),a.language&&(t.second_best=a),t}function b(e){return v.tabReplace&&(e=e.replace(/^((<[^>]+>|\t)+)/gm,function(e,n){return n.replace(/\t/g,v.tabReplace)})),v.useBR&&(e=e.replace(/\n/g,"<br>")),e}function g(e,n,r){var t=n?N[n]:r,a=[e.trim()]
...
d.innerHTML=o.value,o.value=s(u,c(d),t)}o.value=b(o.value),e.innerHTML=o.value,e.className=g(e.className,n,o.language),e.result={language:o.language,re:o.r},o.second_best&&(e.second_best={language:o.second_best.language,re:o.second_best.r})}}function h(){if(!h.called){h.called=!0
var e=document.querySelectorAll("pre code")
Array.prototype.forEach.call(e,d)}}function p(e){return e=e.toLowerCase(),m[e]||m[N[e]]}var v={classPrefix:"hljs-",tabReplace:null,useBR:!1,languages:void 0},m={},N={}
return e.highlight=l,e.highlightAuto=f,e.fixMarkup=b,e.highlightBlock=d,e.configure=function(e){v=o(v,e)},e.initHighlighting=h,e.initHighlightingOnLoad=function(){addEventListener("DOMContentLoaded",h,!1),addEventListener("load",h,!1)},e.registerLanguage=function(n,r){var t=m[n]=r(e)
t.aliases&&t.aliases.forEach(function(e){N[e]=n})},e.listLanguages=function(){return Object.keys(m)},e.getLanguage=p,e.inherit=o,e.IR="[a-zA-Z]\\w*",e.UIR="[a-zA-Z_]\\w*",e.NR="\\b\\d+(\\.\\d+)?",e.CNR="(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",e.BNR="\\b(0b[01]+)",e.RSR="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",e.BE={b:"\\\\[\\s\\S]",r:0},e.ASM={cN:"string",b:"'",e:"'",i:"\\n",c:[e.BE]},e.QSM={cN:"string",b:'"',e:'"',i:"\\n",c:[e.BE]},e.PWM={b:/\b(a|an|the|are|I|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such)\b/},e.C=function(n,r,t){var a=e.inherit({cN:"comment",b:n,e:r,c:[]},t||{})
...
//# sourceMappingURL=highlight.pack-8bead2a40e64a359c4d87e6fc336ed45.map