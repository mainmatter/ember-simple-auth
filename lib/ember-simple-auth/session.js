...
/**
  ...
  [EmberSimpleAuth.Authenticators.Base#authenticate](#Ember-SimpleAuth-Authenticators-Base-authenticate)).
  It is created when EmberSimpleAuth is set up (see
  [EmberSimpleAuth.setup](#Ember-SimpleAuth-setup)) and __injected into all
  ...
  itself (see
  [EmberSimpleAuth.Session#authenticate](#Ember-SimpleAuth-Session-authenticate),
  [EmberSimpleAuth.Session#invaldiate](#Ember-SimpleAuth-Session-invaldiate)
...
var Session = Ember.ObjectProxy.extend({
  ...
  */
  ...
  /**
    ...
    (see [EmberSimpleAuth.setup](#Ember-SimpleAuth-setup)).
  ...
  */
  ...
  /**
    ...
    accordingly__ (see
    [EmberSimpleAuth.Authenticators.Base#invalidate](#Ember-SimpleAuth-Authenticators-Base-invalidate)).
