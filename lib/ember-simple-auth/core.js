...
/**
  The core component of EmberSimpleAuth that holds configuration values and
  provides the main setup function (see
...
var Core = Ember.Namespace.create({
  /**
    ...
    [EmberSimpleAuth.Core.setup](#EmberSimpleAuth-Core-setup).
  ...
  */
  ...
  /**
    ...
    through [EmberSimpleAuth.Core.setup](#EmberSimpleAuth-Core-setup).
