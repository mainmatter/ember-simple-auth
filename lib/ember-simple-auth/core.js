...
/**
  EmberSimpleAuth's configuration object.
...
var Configuration = Ember.Namespace.create({
  ...
  */
  ...
  /**
    ...
    through [EmberSimpleAuth.setup](#EmberSimpleAuth-setup).
  ...
  */
  ...
  /**
    The root path of the Ember.js application; this is not an Ember.js route
    but a
    [URL path](http://de.wikipedia.org/wiki/Uniform_Resource_Locator#Url-path).
    EmberSimpleAuth will redirect to that path after session invalidation.

    @property applicationRootUrl
    @readOnly
    @static
    @type String
    @default [the application's root URL](http://emberjs.com/guides/routing/#toc_specifying-a-root-url)
  */
...
/**
  ...
  @param {Object} [options]
    ...
    @param {String} [options.applicationRootUrl] the root URL of your application; this is not an Ember route but an actual [URL path](http://de.wikipedia.org/wiki/Uniform_Resource_Locator#Url-path); EmberSimpleAuth will redirect to that path after session invalidation - defaults to [the application's root URL](http://emberjs.com/guides/routing/#toc_specifying-a-root-url)
...
var setup = function(container, application, options) {
  ...
  Configuration.applicationRootUrl       = options.applicationRootUrl || (container.lookup('router:main').get('rootURL') || '/');
