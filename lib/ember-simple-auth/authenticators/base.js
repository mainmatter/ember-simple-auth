...
/**
  ...
  authorizer (see
  [EmberSimpleAuth.Authorizers.Base](#Ember-SimpleAuth-Authorizers-Base)).
...
var Base = Ember.Object.extend(Ember.Evented, {
  ...
  */
  ...
  /**
    ...
    [EmberSimpleAuth.AuthenticationControllerMixin.actions#authenticate](#Ember-SimpleAuth-AuthenticationControllerMixin-authenticate)).
    ...
    see
    [EmberSimpleAuth.Authenticators.OAuth2](#Ember-SimpleAuth-Authenticators-OAuth2)).
