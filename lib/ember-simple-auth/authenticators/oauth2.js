...
/**
  ...
  @extends EmberSimpleAuth.Authenticators.Base
*/
var OAuth2 = Base.extend({
  ...
  */
  ...
  /**
    ...
    [EmberSimpleAuth.Authenticators.OAuth2#refreshAccessTokens](#Ember-SimpleAuth-Authenticators-OAuth2-refreshAccessTokens)).
