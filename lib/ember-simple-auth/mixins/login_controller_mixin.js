...
/**
  ...
  specified in
  [EmberSimpleAuth.setup](#EmberSimpleAuth-setup) if the used authentication
  ...
  specialization of
  [EmberSimpleAuth.AuthenticationControllerMixin](#EmberSimpleAuth-AuthenticationControllerMixin).__
  ...
  */
  ...
  actions: {
    /**
      ...
      [EmberSimpleAuth.LoginControllerMixin#authenticatorFactory](#EmberSimpleAuth-LoginControllerMixin-authenticatorFactory)
