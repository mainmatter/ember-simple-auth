  ...
  actions: {
    ...
    */
    ...
    /**
      ...
      @param {any} error The error the promise returned by the authenticator rejects with, see [EmberSimpleAuth.Authenticators.Base#authenticate](#EmberSimpleAuth-Authenticators-Base-authenticate)
    */
    sessionAuthenticationFailed: function(error) {
    },
    ...
    /**
      ...
      [EmberSimpleAuth.ApplicationRouteMixin.sessionInvalidationSucceeded](#EmberSimpleAuth-ApplicationRouteMixin-sessionInvalidationSucceeded)).
