...
/**
  ...
  in [EmberSimpleAuth.setup](#Ember-SimpleAuth-setup)). It provides the
  ...
  */
  ...
  actions: {
    /**
      ...
      action (see
      [EmberSimpleAuth.ApplicationRouteMixin#sessionAuthenticationFailed](#Ember-SimpleAuth-ApplicationRouteMixin-sessionAuthenticationFailed)).
