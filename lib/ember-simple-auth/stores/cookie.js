...
/**
  ...
  alternative is
  [EmberSimpleAuth.Stores.LocalStorage](#EmberSimpleAuth-Stores-LocalStorage)
...
var Cookie = Base.extend({
  ...
  */
  persist: function(properties) {
    ...
    this._lastProperties = this.restore();
  },
  ...
  */
  syncProperties: function() {
    ...
    if (!flatObjectsAreEqual(properties, this._lastProperties)) {
      this._lastProperties = properties;
