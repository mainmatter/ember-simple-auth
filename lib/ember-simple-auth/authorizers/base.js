...
/**
  ...
  origins, see [EmberSimpleAuth.setup](#EmberSimpleAuth-setup)) and makes
...
var Base = Ember.Object.extend({
  /**
    ...
    from (see [EmberSimpleAuth.Session](#EmberSimpleAuth-Session)).
  ...
  */
  ...
  /**
    ...
    authorizer see
    [EmberSimpleAuth.Authorizers.OAuth2](#EmberSimpleAuth-Authorizers-OAuth2)).
