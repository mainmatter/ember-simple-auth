...
#### :rocket: Enhancement
* `ember-simple-auth`
  * [#3121](https://github.com/mainmatter/ember-simple-auth/pull/3121) feat: add `useResolver` flag. Allow session usage without Ember resolver ([@BobrImperator](https://github.com/BobrImperator))
